...
public class FsShell extends Configured implements Tool {
  ...
  /**
   * Check whether user needs to confirm the operation.
   */
  private static boolean isOperationNeedConfirm() {
    return new Configuration().getBoolean("fs.shell.operation.need.confirm", false);
  }
  ...
  public static void main(String argv[]) throws Exception {
    if (isOperationNeedConfirm() && !confirmOperation(argv)) {
      System.exit(-1);
    }
