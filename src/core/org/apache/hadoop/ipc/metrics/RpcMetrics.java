...
public class RpcMetrics implements Updater {
  ...
  public MetricsIntValue numOpenConnections = new MetricsIntValue("NumOpenConnections");
  public MetricsIntValue callQueueLen = new MetricsIntValue("callQueueLen");
  ...
  public void doUpdates(MetricsContext context) {
    ...
    numOpenConnections.pushMetric(metricsRecord);
    callQueueLen.set(myServer.getCallQueueLen());
    callQueueLen.pushMetric(metricsRecord);
