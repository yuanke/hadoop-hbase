...
class JobTrackerMetricsInst extends JobTrackerInstrumentation implements Updater {
  ...
  public void doUpdates(MetricsContext unused) {
    synchronized (this) {
      ...
      int period = ((AbstractMetricsContext)unused).getPeriod();
      heartBeat.pushMetric_OPS(metricsRecord, period);
      assignedReduce.pushMetric_OPS(metricsRecord, period);
      assignedMap.pushMetric_OPS(metricsRecord, period);
