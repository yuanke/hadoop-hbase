...
class QueueManager {
  ...
  // The threshold to highlight scheduling information in jt's webui
  ...
  private void initialize(Configuration conf) {
    ...
    // update highlightThreshold. added by liangly
    highlightThreshold = conf.getFloat("webinterface.queue.tasks.threshold", 1.0f);
  }
  ...
  // call from JobQueueInfo to highlight scheduling info. by liangly
