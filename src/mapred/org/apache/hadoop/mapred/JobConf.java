...
public class JobConf extends Configuration {
  ...
  //add by weichao
  /**
   * Should the job use other pools' slots?
   * 
   * @return should the job user other pools' slots?
   */
  public boolean isJobUseOtherSlots() {
    return getBoolean("mapred.job.use.otherslots", true);
  }
