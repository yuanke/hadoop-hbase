...
class JobTrackerInstrumentation {
  ...
  public MetricsTimeVaryingRate heartBeat = new MetricsTimeVaryingRate("heartBeat");
  public MetricsTimeVaryingRate assignedMap = new MetricsTimeVaryingRate("assignedMap");
  public MetricsTimeVaryingRate assignedReduce = new MetricsTimeVaryingRate("assignedReduce");
