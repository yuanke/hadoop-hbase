...
public class TestJobQueueTaskScheduler extends TestCase {
  ...
  static void submitJobs(FakeTaskTrackerManager taskTrackerManager, JobConf jobConf, int numJobs, int state)
    throws IOException {
  ...
  static TaskTrackerStatus tracker(FakeTaskTrackerManager taskTrackerManager, String taskTrackerName) {
    return taskTrackerManager.getTaskTracker(taskTrackerName);
  }
  
  static void checkAssignment(TaskScheduler scheduler, TaskTrackerStatus tts, String[] expectedTaskStrings) throws IOException {
