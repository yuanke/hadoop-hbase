...
public class TestLimitTasksPerJobTaskScheduler extends TestCase {
  ...
  public void testMaxRunningTasksPerJob() throws IOException {
    ...
    TestJobQueueTaskScheduler.checkAssignment(scheduler,
        TestJobQueueTaskScheduler.tracker(taskTrackerManager, "tt1"),
    ...
    TestJobQueueTaskScheduler.checkAssignment(scheduler,
        TestJobQueueTaskScheduler.tracker(taskTrackerManager, "tt2"),
