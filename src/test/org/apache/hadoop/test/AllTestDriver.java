...
import org.apache.hadoop.mapred.MultiBigMapOutput;
...
public class AllTestDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
      ...
      pgd.addClass("testmultibigmapoutput", MultiBigMapOutput.class, 
          "A map/reduce program that works on multiply very big " + 
          "non-splittable file and does identity map/reduce");
