...
class FSDatasetAsyncDiskService {
  ...
  private static final int MAXIMUM_THREADS_PER_VOLUME = 2;
  ...
  FSDatasetAsyncDiskService(File[] volumes, Configuration conf) {
    ...
    int maxThreadsPerVolume = conf.getInt("dfs.datanode.max.deletion.threads.per.volume", 
    ...
    for (int v = 0 ; v < volumes.length; v++) {
      ...
      ThreadPoolExecutor executor = new ThreadPoolExecutor(
          CORE_THREADS_PER_VOLUME, maxThreadsPerVolume, 
