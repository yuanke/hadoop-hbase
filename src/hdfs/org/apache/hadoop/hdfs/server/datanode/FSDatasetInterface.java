...
public interface FSDatasetInterface extends FSDatasetMBean {
  ...
  /**
   * Recheck the crashed FSVolumes intervally
   * added by wukong
   */
  public List<FSVolume> checkCrashedVolumes();

  /**
   * Put all the block info from the
   * repaired volume to the volumeMap
   * @param vol The repaired Volume
   */
