...
public class JspHelper {
  ...
  public String getInodeLimitText() {
    ...
    str += ".<br>";
    str += "Heap Memory used " + FsShell.byteDesc(totalMemory) + " is "
        + " " + used + "% of Commited Heap Memory " 
        + FsShell.byteDesc(commitedMemory)
        + ". Max Heap Memory is " + FsShell.byteDesc(maxMemory) +
        ". <br>";
    str += "Non Heap Memory used " + FsShell.byteDesc(totalNonHeap) + " is"
        + " " + usedNonHeap + "% of " + " Commited Non Heap Memory "
        + FsShell.byteDesc(commitedNonHeap) + ". Max Non Heap Memory is "
        + FsShell.byteDesc(maxNonHeap) + ".<br>";
    return str;
  }
