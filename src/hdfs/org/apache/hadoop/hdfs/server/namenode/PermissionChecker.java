...
class PermissionChecker {
  ...
  private String pathToBeCheck;
  
  PermissionChecker(String fsOwner, String supergroup, 
		  UserPasswordInformation userPasswordInformation, ExtendAccessControlList eACL) throws AccessControlException{
    ...
    if (ugi != null) {
      ...
      if (!userPasswordInformation.checkUserAndPassword(user, ugi.getPassword(), ugi.getGroupNames())) {
    	  throw new AccessControlException("User " + user + " login failed.");
      }
    ...
    if (null == eACL) {
    	throw new AccessControlException("ExtendAccessControlList = null");
    }
    extendAccessControlList = eACL;
  }
  ...
  private void check(INode inode, FsAction access
    ...
    //check extend acl
    if (extendAccessControlList.check(user, pathToBeCheck, access)) {
    	return;
    }
