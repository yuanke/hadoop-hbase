...
public class NameNode implements ClientProtocol, DatanodeProtocol,
  ...
  private void startHttpServer(Configuration conf) throws IOException {
    ...
    if (null != keyloc) {
      this.httpServer.addSslListener(secInfoSocAddr, keyloc,
    ...
    this.httpServer.setAttribute("datanode.https.port",
   ...
   * <ul> 
   * <li>{@link StartupOption#REGULAR REGULAR} - normal startup</li>
  ...
  public LocatedFileStatus[] getLocatedListing(String src) throws IOException {
    FileStatus[] files = namesystem.getLocatedListing(src);
    if (files != null) {
      myMetrics.numGetListingOps.inc();
    }
    return (LocatedFileStatus[]) files;
  }
  ...
  /**
   * Returns the address of the NameNode's http server,
