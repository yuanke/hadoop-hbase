...
<%-- Show some File Systems Counters for administrators -liangly --%>
<%
if (request.getParameter("advanced") == null) {
   out.println(JSPUtil.generateJobTable("Running", runningJobs, 30, 0));
} else {
   out.println(JSPUtil.generateJobAdminTable("Running", runningJobs, 30, 0, true));
}
%>
<hr>
