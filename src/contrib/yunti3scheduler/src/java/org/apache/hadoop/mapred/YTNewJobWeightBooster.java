...
/**
 * A {@link YTWeightAdjuster} implementation that gives a weight boost to new jobs
 ...
 */
public class YTNewJobWeightBooster extends Configured implements YTWeightAdjuster {
  ...
  public double adjustWeight(JobInProgress job, YTTaskType taskType,
      double curWeight) {
