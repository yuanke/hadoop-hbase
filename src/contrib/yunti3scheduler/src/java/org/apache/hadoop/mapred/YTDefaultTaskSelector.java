...
/**
 * A {@link YTTaskSelector} implementation that wraps around the default
 ...
 */
public class YTDefaultTaskSelector extends YTTaskSelector {
  ...
  @Override
  public Task obtainNewMapTask(TaskTrackerStatus taskTracker, JobInProgress job, int localityLevel)
      throws IOException {
